...
# E.S.O. - VLT project
#
# "@(#) $Id: vltMakeTestPanel3.pan,v 1.1.1.1 2003/02/20 10:44:07 mzampare Exp $" 
#
# xxx.pan
#
# This file has been produced by the panel editor
#   version: panel.tcl,v 2.40+
#   date   : Mon Aug 21 21:44:51 MESZ 1995
#
...
#
# User's defined Initialization Procedure
#
...
panCreateFrame xxx 198 443;  # Create empty frame
panGetCvNames  xxx cv bcv; # Get Canvas Names 

UifButton          $cv.xxx-wdg1 -popup 1 -stateVar gvar(dummy_panel-wdg1) \
...
#
set panWidget(xxx-wdg1)  {UifButton 20 20 1 0 0 0 0 dummy_panel-wdg1 0 {}}
