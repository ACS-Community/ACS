...
the WS part on Sun. On Sun also make sure to undefine WIND_BASE.
On Sun testint LCU part copy TestList_BOTH.lite to TestList.lite.
...
The Makefile:
It is changed so that it copies appropirate reference files and
TestList.lite file.  
