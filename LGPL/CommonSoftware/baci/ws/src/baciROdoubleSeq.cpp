...
*
* "@(#) $Id: baciROdoubleSeq.cpp,v 1.98 2009/09/16 07:55:41 bjeram Exp $"
*
* who       when        what
* --------  ---------   ----------------------------------------------
...
template void baci::ROcommonImpl<ACS_RO_SEQ_T(double, CORBA::Double)>::setAlarmFaultFamily(const char* ff);
template void baci::ROcommonImpl<ACS_RO_SEQ_T(double, CORBA::Double)>::setAlarmFaultMember(const char* fm);
