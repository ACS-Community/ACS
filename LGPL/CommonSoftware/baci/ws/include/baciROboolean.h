...
/** @defgroup RObooleanTemplate ROboolean Class
 * The ROboolean class is a templated typedef so there is no actual inline doc generated for it per-se.
 *  @{
 * The ROboolean class is an implementation of the ACS::ROboolean IDL interface.
 */
typedef  ROcontImpl<ACS_RO_T(boolean, CORBA::Boolean)> ROboolean;
/** @} */
