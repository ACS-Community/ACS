...
*
* "@(#) $Id: DoubleParam.h,v 1.3 2005/08/15 23:26:53 sharring Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
...
namespace parameterSet {
	 ...
	 */
	class DoubleParam : public parameterSet::QuantityParam
	{    
	  public:
	    /**
	     * Constructor
	     ...
	     * Constructor
	     */
	    DoubleParam(double doubleVal, string nameVal, auto_ptr<string> unitsVal);
