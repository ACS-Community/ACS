 ...
 *
 * "@(#) $Id: testLTSClient.cpp,v 1.2 2007/02/07 14:07:40 nbarriga Exp $"
 *
 * who       when      what
 * --------  --------  ----------------------------------------------
...
static char *rcsId="@(#) $Id: testLTSClient.cpp,v 1.2 2007/02/07 14:07:40 nbarriga Exp $"; 
...
int main(int argc, char *argv[])
{
	...
	my_complexLog.setsomeMember(3.14159);
	my_complexLog.log();
