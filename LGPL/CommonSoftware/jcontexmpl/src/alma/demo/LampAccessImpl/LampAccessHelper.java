...
import alma.demo.LampAccessPOATie;

/**
 * @author alma-component-helper-generator-tool
 */
public class LampAccessHelper extends ComponentHelper
{
	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public LampAccessHelper(Logger containerLogger)
	{
	...
	{
		return LampAccessOperations.class;
	}
