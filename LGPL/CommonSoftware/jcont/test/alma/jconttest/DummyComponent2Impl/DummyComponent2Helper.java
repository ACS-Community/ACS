...
package alma.jconttest.DummyComponent2Impl;
...
import alma.jconttest.DummyComponent2Operations;
import alma.jconttest.DummyComponent2POATie;
import alma.jconttest.DummyComponent2Impl.DummyComponent2Impl;
 ...
 * <p>
 * Name="DUMMYCOMPONENT2_1" Code="alma.jconttest.DummyComponent2Impl.DummyComponent2Helper" Type="IDL:alma/jconttest/DummyComponent2:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class DummyComponent2Helper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public DummyComponent2Helper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new DummyComponent2Impl();
	}
	...
	*/
	...
	{
		return DummyComponent2POATie.class;
	}
	...
	*/
	...
	{
		return DummyComponent2Operations.class;
	}
