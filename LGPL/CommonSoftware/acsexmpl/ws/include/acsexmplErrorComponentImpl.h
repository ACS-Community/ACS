...
*
* "@(#) $Id: acsexmplErrorComponentImpl.h,v 1.2 2006/05/11 13:13:19 bjeram Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
 ...
 * @version "@(#) $Id: acsexmplErrorComponentImpl.h,v 1.2 2006/05/11 13:13:19 bjeram Exp $"
 */
...
{    
  public:
   ...
   /**
    ...
    /**
     * This method whiich implements IDL method throws a REMOTE (CORBA) type exception if depth>0.
  ...
  private:
     ...
     * @param depth depth of the error trace
     */
    virtual ACSErr::CompletionImpl *returnCompletion(unsigned short depth);
