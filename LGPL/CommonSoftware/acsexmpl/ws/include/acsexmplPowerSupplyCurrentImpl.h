 ...
 * @htmlonly
 ...
 <div align="left">
 <h2>Description</h2>
 PowerSupplyCurrent is provided to show how flexible BACI properties can be.  You 
 ...
 <ul>
   <li>an example which overrides the ACS implementation of a BACI property.</li>
 ...
 * to a ROdouble that represents the actual readback value of the current.
...
class acsexmpl_EXPORT PowerSupplyCurrent : public RWdouble
{
  ...
  private:
     ...
     * It just points to the ROdouble passed to this class's constructor.  This is done so 
     * that we can synchronize this class and the ROdouble's value. 
     */
