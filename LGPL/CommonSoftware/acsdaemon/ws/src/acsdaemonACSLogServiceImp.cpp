...
#include "acsACSLogServiceImpHandlerImpl.h"

acsDaemonImpl<ACSLogServiceImpHandlerImpl>* g_daemon = 0; //Reference used by signal handler
...
{
    acsDaemonImpl<ACSLogServiceImpHandlerImpl> daemon(argc,argv);
