...
#include "acsLoggingServiceImpHandlerImpl.h"

acsDaemonImpl<ACSLoggingServiceImpHandlerImpl>* g_daemon = 0; //Reference used by signal handler
...
{
    acsDaemonImpl<ACSLoggingServiceImpHandlerImpl> daemon(argc,argv);
