...
#include "acsAlarmServiceImpHandlerImpl.h"

acsDaemonImpl<ACSAlarmServiceImpHandlerImpl>* g_daemon = 0; //Reference used by signal handler
...
{
    acsDaemonImpl<ACSAlarmServiceImpHandlerImpl> daemon(argc,argv);
