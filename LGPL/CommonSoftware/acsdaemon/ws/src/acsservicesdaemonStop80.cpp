 ...
 * E.S.O. - ACS project
 *
 * "@(#) $Id: acsservicesdaemonStop80.cpp,v 1.1 2008/08/29 13:58:28 msekoran Exp $"
 *
 * who       when        what
 * --------  ----------  ----------------------------------------------
 * azagar    2008-08-25  Created
 */

/** @file acsservicesdaemonStop80.cpp
 *  acsservicesdaemonStop80 is used to remotely stop ACS Services Deamon.
 *  @htmlonly
 *  <br><hr>
 *  @endhtmlonly
 */   
