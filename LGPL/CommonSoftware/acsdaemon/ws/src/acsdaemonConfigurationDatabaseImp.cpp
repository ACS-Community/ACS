...
#include "acsConfigurationDatabaseImpHandlerImpl.h"

acsDaemonImpl<ACSConfigurationDatabaseImpHandlerImpl>* g_daemon = 0; //Reference used by signal handler
...
{
    acsDaemonImpl<ACSConfigurationDatabaseImpHandlerImpl> daemon(argc,argv);
