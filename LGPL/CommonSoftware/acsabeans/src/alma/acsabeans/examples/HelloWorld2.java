 ...
 * @version		$Id: HelloWorld2.java,v 1.3 2003/10/31 08:50:47 msekoran Exp $
 */
public class HelloWorld2 extends ACSAbeansEngine 
{
	/**
	 * Constructor.
	 */
	...
	public void sayHello()
	{
		...
		new MessageLogEntry(this, "Hello world!", LoggingLevel.INFO).dispatch();
	}
