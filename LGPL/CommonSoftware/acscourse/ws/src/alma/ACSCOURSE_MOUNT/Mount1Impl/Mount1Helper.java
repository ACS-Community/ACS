...
import alma.ACSCOURSE_MOUNT.Mount1POATie;
 ...
 */
public class Mount1Helper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public Mount1Helper(Logger containerLogger)
	{
