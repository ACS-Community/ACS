 ...
 * <p>
 * Name="CONTROLLER_1" Code="alma.MonitorArchiver.ControllerImpl.MockControllerHelper" Type="IDL:alma/MonitorArchiver/Controller:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class MockControllerHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public MockControllerHelper(Logger containerLogger)
	{
