...
*
* "@(#) $Id: contLogTestImpl.h,v 1.1.1.1 2007/11/13 14:25:38 eallaert Exp $"
*
* who       when        what
* --------  ----------  ----------------------------------------------
...
/**
 *  The empty CORBA servant interface, POA_contLogTest::LogLevels,
 ...
 * derives from POA_contLogTest::LogLevels which is a class automatically 
 * generated by CORBA from contLogTest's IDL file.
 * @version "@(#) $Id: contLogTestImpl.h,v 1.1.1.1 2007/11/13 14:25:38 eallaert Exp $"
 */
class LogLevels: public virtual ACSComponentImpl,     //Component superclass
		  public POA_contLogTest::LogLevels    //CORBA servant stub
{    
  public:
    /**
     * Constructor
