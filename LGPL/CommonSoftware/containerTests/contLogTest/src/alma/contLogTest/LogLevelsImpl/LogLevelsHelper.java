...
import alma.contLogTest.LogLevelsOperations;
import alma.contLogTest.LogLevelsPOATie;
import alma.contLogTest.LogLevelsImpl.LogLevelsImpl;
 ...
 * <p>
 * Name="LOGLEVELS_1" Code="alma.contLogTest.LogLevelsImpl.LogLevelsHelper" Type="IDL:alma/contLogTest/LogLevels:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class LogLevelsHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public LogLevelsHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return LogLevelsOperations.class;
	}
