 ...
 * @author eallaert
 */
public class LogLevelsImpl implements ComponentLifecycle, LogLevelsOperations
{
	public static final String PROP_ASSERTION_MESSAGE = "LogLevelsAssert"; 
	...
	/////////////////////////////////////////////////////////////
	// Implementation of LogLevelsOperations
	/////////////////////////////////////////////////////////////
	...
	public int[] getLevels() throws CouldntPerformActionEx {
		...
		int acsCoreLevel = acsLevel.getAcsLevel();
		...
		if (levelRemote == null)	// should never be the case, but anyway ...
			...
			levels[3] = levelRemote.getAcsLevel();
		if (levelStdout == null)	// should never be the case, but anyway ...
			levels[4] = -1;
		else
			levels[4] = levelStdout.getAcsLevel();
