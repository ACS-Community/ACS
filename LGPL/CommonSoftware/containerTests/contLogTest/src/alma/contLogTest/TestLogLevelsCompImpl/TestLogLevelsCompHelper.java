...
import alma.contLogTest.TestLogLevelsCompPOATie;
import alma.contLogTest.TestLogLevelsCompImpl.TestLogLevelsCompImpl;
 ...
 * <p>
 * Name="TestLogLevelsComp_1" Code="alma.contLogTest.TestLogLevelsCompImpl.TestLogLevelsCompHelper" Type="IDL:alma/contLogTest/TestLogLevelsComp:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class TestLogLevelsCompHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public TestLogLevelsCompHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new TestLogLevelsCompImpl();
	}
	...
	*/
	...
	{
		return TestLogLevelsCompPOATie.class;
	}
	...
	*/
	...
	{
		return TestLogLevelsCompOperations.class;
	}
