...
/**
 * Client application that accesses the LogLevels component. It demonstrates
 * how the class {@link ComponentClient} can be used as a base class.
 * 
 * @author eallaert 30 October 2007
 */
public class LogLevelsClient extends ComponentClient
{
     ...
     * @throws Exception
     */
    public LogLevelsClient(Logger logger, String managerLoc, String clientName)
	throws Exception {
    ...
    public void doSomeStuff() throws AcsJContainerServicesEx, CDBXMLErrorEx, CDBRecordDoesNotExistEx, CouldntPerformActionEx {
    	...
    	m_testlogComp = alma.contLogTest.LogLevelsHelper.narrow(getContainerServices().getComponent("TESTLOG1"));
    ...
    public static void main(String[] args) {
    	...
    	LogLevelsClient hlc = null;
    	try 
    	{
    		hlc = new LogLevelsClient(null, managerLoc, clientName);
    		hlc.doSomeStuff();
    	}
    	catch (Exception e)
    	{
