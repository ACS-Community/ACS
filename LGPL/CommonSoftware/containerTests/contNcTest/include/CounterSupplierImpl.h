#ifndef _COUNTER_SUPPLIER_H
#define _COUNTER_SUPPLIER_H
/*******************************************************************************
...
*
* "@(#) $Id: CounterSupplierImpl.h,v 1.2 2008/07/25 07:45:52 cparedes Exp $"
*
* who       when        what
* --------  ----------  ----------------------------------------------
...
/**
 *  The empty CORBA servant interface, POA_COUNTER::CounterSupplier,
 ...
 * derives from POA_COUNTER::CounterSupplier which is a class automatically 
 * generated by CORBA from COUNTER's IDL file.
 * @version "@(#) $Id: CounterSupplierImpl.h,v 1.2 2008/07/25 07:45:52 cparedes Exp $"
 */
class CounterSupplierImpl: public virtual acscomponent::ACSComponentImpl,     //Component superclass
		  public virtual POA_COUNTER::CounterSupplier    //CORBA servant stub
{    
  public:
    /**
     * Constructor
     ...
     */     
    virtual CORBA::Long 
    sendBlocks(const CORBA::Long initialVal,
