...
*
* "@(#) $Id: CounterConsumerImpl.h,v 1.2 2008/07/25 07:45:52 cparedes Exp $"
*
* who       when        what
* --------  ----------  ----------------------------------------------
 ...
 * @version "@(#) $Id: CounterConsumerImpl.h,v 1.2 2008/07/25 07:45:52 cparedes Exp $"
 */
...
{    
  public:
     ...
     * @htmlonly
       ...
       @endhtmlonly
     */     
	virtual void getBlocks() throw(CORBA::SystemException, ACSErrTypeCommon::CouldntPerformActionEx);
	virtual CORBA::Long waitTillDone() throw (CORBA::SystemException, ACSErrTypeCommon::CouldntPerformActionEx);
