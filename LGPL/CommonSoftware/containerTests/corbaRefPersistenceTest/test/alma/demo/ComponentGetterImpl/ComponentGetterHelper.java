...
import alma.demo.ComponentGetterPOATie;
 ...
 * <p>
 * Name="COMPONENTGETTER_1" Code="alma.demo.ComponentGetterImpl.ComponentGetterHelper" Type="IDL:alma/demo/ComponentGetter:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class ComponentGetterHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public ComponentGetterHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new ComponentGetterImpl();
	}
	...
	*/
	...
	{
		return ComponentGetterPOATie.class;
	}
	...
	*/
	...
	{
		return ComponentGetterOperations.class;
	}
