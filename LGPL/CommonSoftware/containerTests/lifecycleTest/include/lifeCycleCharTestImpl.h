...
*
* "@(#) $Id: lifeCycleCharTestImpl.h,v 1.1 2008/03/24 07:43:35 cparedes Exp $"
*
* who       when        what
* --------  ----------  ----------------------------------------------
 ...
 * @version "@(#) $Id: lifeCycleCharTestImpl.h,v 1.1 2008/03/24 07:43:35 cparedes Exp $"
 */
class TestLifeCycleCharComp: public CharacteristicComponentImpl,     //Component superclass
...
{    
  public:
    ...
    SmartPropertyPointer<RWlong>m_value;
};
/*\@}*/
/*\@}*/
