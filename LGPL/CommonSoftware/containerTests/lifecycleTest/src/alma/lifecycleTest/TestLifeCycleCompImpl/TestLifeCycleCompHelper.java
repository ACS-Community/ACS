...
import alma.lifecycleTest.TestLifeCycleCompPOATie;
import alma.lifecycleTest.TestLifeCycleCompImpl.TestLifeCycleCompImpl;
 ...
 */
public class TestLifeCycleCompHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public TestLifeCycleCompHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new TestLifeCycleCompImpl();
	}
	...
	*/
	...
	{
		return TestLifeCycleCompPOATie.class;
	}
	...
	*/
	...
	{
		return TestLifeCycleCompOperations.class;
	}
