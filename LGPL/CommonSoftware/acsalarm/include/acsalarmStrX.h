#ifndef _ACSALARMSTR_X_H
#define _ACSALARMSTR_X_H
/*******************************************************************************
...
*
* "@(#) $Id: acsalarmStrX.h,v 1.1 2010/04/27 12:06:51 htischer Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
...
namespace acsalarm {
	...
	inline XERCES_STD_QUALIFIER ostream& operator<<(std::ostream& target, const acsalarm::StrX& toDump)
	{
