...
public class acssampPanel extends AbeansLaunchable {
  ...
  //      java.awt.Component [] prova = getComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        spike1 = new com.cosylab.abeans.displayers.Trend();
    ...
    private void buttonSampleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSampleActionPerformed
        ...
        try {
            ...
            long lFreq = 
                (long) ( (1 / Double.parseDouble(textFrequency.getText())) * 10000000);;
            ...
            ncObj = new acssampGUIConsumer(ncChannel);


        try
        {
	    //Subscribe to a domain and event type.
	    ncObj.addSubscription("");
        ...
        catch(Exception e)
        {
            ...
            //This is used outside of a Container, so we must disconnect the Helper
            //object.
        ...
        } catch (Exception e)
 {
    ...
    private com.cosylab.abeans.displayers.Trend spike1;
