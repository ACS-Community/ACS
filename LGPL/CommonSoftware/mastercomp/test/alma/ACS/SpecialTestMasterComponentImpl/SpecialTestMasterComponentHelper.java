 ...
 * <p>
 * Name="SPECIALTESTMASTERCOMPONENT1" Code="alma.ACS.SpecialTestMasterComponentImpl.SpecialTestMasterComponentHelper" Type="IDL:alma/ACS/SpecialTestMasterComponent:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class SpecialTestMasterComponentHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public SpecialTestMasterComponentHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new SpecialTestMasterComponentImpl();
	}
