...
public class BACIIntrospector {
	...
	public static final String ID_PROPERTY = "IDL:ANKA/ACS/Property:1.0";
	public static final String ID_CALLBACK = "IDL:ANKA/ACS/Callback:1.0";
	public static final String ID_DEVICE = "IDL:ANKA/ACS/DO:1.0";
	public static final String ID_SUBSCRIPTION = "IDL:ANKA/ACS/Subscription:1.0";
	public static final String ID_CBDESCIN = "IDL:ANKA/ACS/CBDescIn:1.0";
	public static final String METHOD_DONE = "done";
	public static final String METHOD_DESTROY = "destroy";
	public static final String IDL_PACKAGE_PREFIX = "ANKA.";
	public static final String BACI_PACKAGE_PREFIX = "ANKA.ACS.";
/**
 * BACIIntrospector constructor comment.
 */
public BACIIntrospector(ANKARemoteAccess ra) {
	super();
...
public java.lang.Object extractAny(Any argument) {
	...
	switch(argument.type().kind().value())
	{
		case TCKind._tk_any:
...
/**
 * Insert the method's description here.
 * Creation date: (12.2.2002 18:48:26)
 * @return java.lang.Class
 * @param tc org.omg.CORBA.TypeCode
 */
public Class extractBasicTypeFromTC(TypeCode tc) {
	...
	switch(tc.kind().value())
	{
		...
		case TCKind._tk_alias:
			try
			{
				return extractBasicTypeFromTC(tc.content_type());
//				else throw new IllegalArgumentException("Do not know how to handle alias typecodes other than those that represent sequences and have names ending with 'Seq'. Typecode being processed was '" + tc.id());
		...
		case TCKind._tk_sequence:
		{
			try
			{
				Class content = extractBasicTypeFromTC(tc.content_type());
...
public java.lang.Object extractTypedef(Any argument) {
	...
	try
	{
		className = IDtoClassName(argument.type().id()) + "Helper";
...
public int getCallbackLocation(Operation op) {
	...
	{
		if (ANKA.ACS.Callback.class.isAssignableFrom(args[i]))
		{
			...
			if (ra.isStrict() && !args[i+1].equals(ANKA.ACS.CBDescIn.class)) throw new IntrospectionInconsistentException("Operation '" + op + "' does not take a 'CBDescIn' parameter after 'Callback' parameter.");
		}
	}
	return count;
}
...
public void insertTypedef(ParameterDescription desc, java.lang.Object o, Any any) {
	...
	{
		throw new JavaIDLIntrospectionException("Error while dynamically inserting a typedef value into 'Any' by loading helper class '" + className + "'. Exception: " + e);
	}
