 ...
 */
public BACIRemoteNode(int newType, String name, Object data, si.ijs.acs.objectexplorer.OETree newParentTree, ANKARemoteAccess ra) {
...
public java.lang.String getName() {
	...
	if (getNodeType()!=ANKARemoteAccess.DEVICE) return ((si.ijs.acs.objectexplorer.OETreeNode)getParent()).getName()+" : "+name;
	else return name;
}
/**
 * Insert the method's description here.
