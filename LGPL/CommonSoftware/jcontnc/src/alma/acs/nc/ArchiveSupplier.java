...
/** 
 * @author  dfugate
 * @version $Id: ArchiveSupplier.java,v 1.3 2006/01/27 19:07:08 dfugate Exp $
 * @since    
 */
...
public class ArchiveSupplier extends SimpleSupplier
{
     ...
     */
    public ArchiveSupplier(ContainerServices services)
	throws AcsJException
	{
	    super(alma.acscommon.ARCHIVING_CHANNEL_NAME.value,
		  services);
	}
    /**
     * Overridden.
