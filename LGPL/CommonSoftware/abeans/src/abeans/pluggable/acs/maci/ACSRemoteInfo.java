...
/**
 * This class is a MACI plug implementation of <code>RemoteInfo</code> interface.
 ...
 * <p>
 * <b>abeans-MACI://dina.ijs.si:xxxx/PSBEND_M.01/current
 * </p>
 * or it may be represented as a JNDI <code>javax.naming.Name</code> sequence:
 * <p>
 * [0]=abeans-MACI [1]=dina.ijs.si:xxxx [2]=PSBEND_M.01 [3]=current
 * </p>
 ...
 * @see		RemoteInfo
 */
public class ACSRemoteInfo extends DefaultRemoteInfo
{
	 ...
	 */
	public ACSRemoteInfo(Name name, TargetPart[] targets) throws NamingException
	{
		super(name, targets);
	}
	 ...
	 */
	public ACSRemoteInfo(Binding[] bindings) throws NamingException
	{
		super(bindings);
	}
