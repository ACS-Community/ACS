 ...
 */
public class SimpleMasterComponentImplHelper extends ComponentHelper
{
	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public SimpleMasterComponentImplHelper(Logger containerLogger)
	{
	...
	{
		return new SimpleMasterComponentImpl();
	}
	...
	{
		return SimpleMasterComponentPOATie.class;
	}
	...
	{
		return SimpleMasterComponentOperations.class;
	}
