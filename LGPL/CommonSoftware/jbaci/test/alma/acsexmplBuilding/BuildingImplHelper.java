 ...
 */
public class BuildingImplHelper extends ComponentHelper
{
	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public BuildingImplHelper(Logger containerLogger)
	{
	...
	{
		return BuildingOperations.class;
	}
