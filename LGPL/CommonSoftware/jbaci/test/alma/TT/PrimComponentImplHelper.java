 ...
 */
public class PrimComponentImplHelper extends ComponentHelper
{
	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public PrimComponentImplHelper(Logger containerLogger)
	{
	...
	{
		return PrimComponentPOATie.class;
	}
	...
	{
		return PrimComponentOperations.class;
	}
