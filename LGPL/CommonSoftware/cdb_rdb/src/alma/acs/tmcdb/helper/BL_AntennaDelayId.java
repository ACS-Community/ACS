...
/**
 * BL_AntennaDelayId generated by hbm2java
 */
@SuppressWarnings("serial")
@Embeddable
public class BL_AntennaDelayId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BL_AntennaDelayId) ) return false;
		 BL_AntennaDelayId castOther = ( BL_AntennaDelayId ) other;
