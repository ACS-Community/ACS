...
@Entity
@Table(name="`BL_POINTINGMODELCOEFF`"
)
@TypeDef(name="BL_PointingModelCoeffOp", typeClass=StringEnumUserType.class,
   parameters={ @Parameter(name="enumClassName", value="alma.acs.tmcdb.BL_PointingModelCoeffOp") })
public class BL_PointingModelCoeff extends alma.acs.tmcdb.translator.TmcdbObject implements java.io.Serializable {


     protected BL_PointingModelCoeffId id;
     protected String who;
     protected String changeDesc;
     protected Double coeffValue;

    public BL_PointingModelCoeff() {
    }
    ...
    public BL_PointingModelCoeffId getId() {
        return this.id;
    }
    
    public void setId(BL_PointingModelCoeffId id) {    
