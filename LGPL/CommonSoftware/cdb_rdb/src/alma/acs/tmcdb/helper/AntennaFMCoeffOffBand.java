 ...
 * and represents the 'AntennaFMCoeffOffBand' CHECK constraint defined for the 'ReceiverBand' column of the 'FocusModelCoeffOffset' table.
 *
 * <p>This is automatic generated code, so don't try to change it by yourself!
 */
public enum AntennaFMCoeffOffBand {
	...
	AntennaFMCoeffOffBand(String value) {
		_stringValue = value;
	}
	...
	public static AntennaFMCoeffOffBand valueOfForEnum(String value) {
		...
		if( value.equals("ALMA_RB_10") )
			...
			throw new RuntimeException("Invalid value for AntennaFMCoeffOffBand enumeration: " + value);
	}
