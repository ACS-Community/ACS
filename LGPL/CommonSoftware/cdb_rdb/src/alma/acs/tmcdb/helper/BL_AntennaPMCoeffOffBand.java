 ...
 * and represents the 'BL_AntennaPMCoeffOffBand' CHECK constraint defined for the 'ReceiverBand' column of the 'BL_PointingModelCoeffOffset' table.
 *
 * <p>This is automatic generated code, so don't try to change it by yourself!
 */
public enum BL_AntennaPMCoeffOffBand {
	...
	BL_AntennaPMCoeffOffBand(String value) {
		_stringValue = value;
	}
	...
	public static BL_AntennaPMCoeffOffBand valueOfForEnum(String value) {
		...
		if( value.equals("ALMA_RB_10") )
			...
			throw new RuntimeException("Invalid value for BL_AntennaPMCoeffOffBand enumeration: " + value);
	}
