...
@Entity
@Table(name="`BL_FOCUSMODELCOEFF`"
)
@TypeDef(name="BL_FocusModelCoeffOp", typeClass=StringEnumUserType.class,
   parameters={ @Parameter(name="enumClassName", value="alma.acs.tmcdb.BL_FocusModelCoeffOp") })
public class BL_FocusModelCoeff extends alma.acs.tmcdb.translator.TmcdbObject implements java.io.Serializable {


     protected BL_FocusModelCoeffId id;
     protected String who;
     protected String changeDesc;
     protected Double coeffValue;

    public BL_FocusModelCoeff() {
    }
    ...
    public BL_FocusModelCoeffId getId() {
        return this.id;
    }
    
    public void setId(BL_FocusModelCoeffId id) {    
