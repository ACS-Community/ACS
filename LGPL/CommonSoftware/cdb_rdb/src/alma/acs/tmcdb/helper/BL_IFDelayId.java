...
/**
 * BL_IFDelayId generated by hbm2java
 */
@SuppressWarnings("serial")
@Embeddable
public class BL_IFDelayId  implements java.io.Serializable {


     private Integer version;
     private Long modTime;
     private BL_IFDelayOp operation;
     private Integer IFDelayId;
    ...
    public BL_IFDelayOp getOperation() {
        return this.operation;
    }
    
    public void setOperation(BL_IFDelayOp operation) {    
    	this.operation = operation;
    }



    @Column(name="`IFDELAYID`", nullable=false)
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BL_IFDelayId) ) return false;
		 BL_IFDelayId castOther = ( BL_IFDelayId ) other;
 ...
 && ( (this.getIFDelayId()==castOther.getIFDelayId()) || ( this.getIFDelayId()!=null && castOther.getIFDelayId()!=null && this.getIFDelayId().equals(castOther.getIFDelayId()) ) );
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getIFDelayId() == null ? 0 : this.getIFDelayId().hashCode() );
         return result;
   }
