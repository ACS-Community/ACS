 ...
 * and represents the 'AntennaPMCoeffOffBand' CHECK constraint defined for the 'ReceiverBand' column of the 'PointingModelCoeffOffset' table.
 *
 * <p>This is automatic generated code, so don't try to change it by yourself!
 */
public enum AntennaPMCoeffOffBand {
	...
	AntennaPMCoeffOffBand(String value) {
		_stringValue = value;
	}
	...
	public static AntennaPMCoeffOffBand valueOfForEnum(String value) {
		...
		if( value.equals("ALMA_RB_10") )
			...
			throw new RuntimeException("Invalid value for AntennaPMCoeffOffBand enumeration: " + value);
	}
