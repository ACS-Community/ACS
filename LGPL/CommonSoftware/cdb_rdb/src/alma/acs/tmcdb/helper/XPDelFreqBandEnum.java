 ...
 * and represents the 'XPDelFreqBandEnum' CHECK constraint defined for the 'ReceiverBand' column of the 'XPDelay' table.
 *
 * <p>This is automatic generated code, so don't try to change it by yourself!
 */
public enum XPDelFreqBandEnum {
	...
	XPDelFreqBandEnum(String value) {
		_stringValue = value;
	}
	...
	public static XPDelFreqBandEnum valueOfForEnum(String value) {
		...
		if( value.equals("ALMA_RB_10") )
			...
			throw new RuntimeException("Invalid value for XPDelFreqBandEnum enumeration: " + value);
	}
