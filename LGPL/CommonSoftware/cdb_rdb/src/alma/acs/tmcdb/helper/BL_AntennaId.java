...
/**
 * BL_AntennaId generated by hbm2java
 */
@SuppressWarnings("serial")
@Embeddable
public class BL_AntennaId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BL_AntennaId) ) return false;
		 BL_AntennaId castOther = ( BL_AntennaId ) other;
