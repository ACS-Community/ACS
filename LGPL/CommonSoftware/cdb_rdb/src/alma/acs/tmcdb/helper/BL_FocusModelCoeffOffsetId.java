...
/**
 * BL_FocusModelCoeffOffsetId generated by hbm2java
 */
@SuppressWarnings("serial")
@Embeddable
public class BL_FocusModelCoeffOffsetId  implements java.io.Serializable {


     private Integer version;
     private Long modTime;
     private BL_AntennaFMCoeffOffOp operation;
     private Integer focusModelId;
     private String coeffName;
     private BL_AntennaFMCoeffOffBand receiverBand;

    public BL_FocusModelCoeffOffsetId() {
    }
    ...
    public BL_AntennaFMCoeffOffOp getOperation() {
        return this.operation;
    }
    
    public void setOperation(BL_AntennaFMCoeffOffOp operation) {    
    ...
    public BL_AntennaFMCoeffOffBand getReceiverBand() {
        return this.receiverBand;
    }
    
    public void setReceiverBand(BL_AntennaFMCoeffOffBand receiverBand) {    
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BL_FocusModelCoeffOffsetId) ) return false;
		 BL_FocusModelCoeffOffsetId castOther = ( BL_FocusModelCoeffOffsetId ) other;
