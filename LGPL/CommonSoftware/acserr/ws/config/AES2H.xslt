...
*
* "@(#) $Id: AES2H.xslt,v 1.26 2012/01/27 10:59:54 bjeram Exp $"
...
{
	static const ACSErr::ACSErrType acserrGen_EXPORT m_etype=ACSErr::</xsl:text>
				<xsl:value-of select="../@name"/>
				<xsl:text>; // = </xsl:text>
				<xsl:value-of select="../@type"/>
				<xsl:text>
	static const ACSErr::ErrorCode acserrGen_EXPORT m_code = </xsl:text>
				<xsl:value-of select="@name"/>
				<xsl:text>;
	static const char acserrGen_EXPORT m_shortDescription[];
