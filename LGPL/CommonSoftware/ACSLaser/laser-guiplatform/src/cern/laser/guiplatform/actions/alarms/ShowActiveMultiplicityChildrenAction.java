 ...
 */
public class ShowActiveMultiplicityChildrenAction extends NodeAction {

    /** logger */
    private static final Logger logger = 
            LogFactory.getLogger(ShowActiveMultiplicityChildrenAction.class.getName());
    
    private final ContainerServicesBase contSvcs;
    
    public ShowActiveMultiplicityChildrenAction(ContainerServicesBase contSvcs) {
    ...
    protected void performAction(Node[] _nodes) {
        ...
        AcWindowManager.setStatusText("Show active multiplicity children action is running .......");


        //AlarmBean _ab = (AlarmBean) _nodes[0].getCookie(AlarmBean.class);
        
        AlarmBean _ab = (AlarmBean) ((AlarmBeanNode) _nodes[0]).getBean();
        ...
        List abAlarms = new java.util.ArrayList();
         try {
            ...
            Collection alarms = browser.getActiveMultiplicityChildren(_ab.getAlarmId());
            ...
            if ( top != null ) {
                ...
                expl.update(abAlarms, 
                            _ab.getFaultFamily() + " active multiplicity children");
        ...
        AcWindowManager.setStatusText("Show active multiplicity children action finished");
    ...
    public String getName() {
        return NbBundle.getMessage(ShowActiveMultiplicityChildrenAction.class, 
                "LBL_ShowActiveMultiplicityChildrenAction_action_name");
    }
