 ...
 */
public class ShowActiveNodeChildrenAction extends NodeAction {
         ...
         try {
            ...
            if ( top != null ) {
                ...
                expl.update(abAlarms, 
                            _ab.getFaultFamily() + " active node children");
    ...
    public String getName() {
        return NbBundle.getMessage(ShowActiveNodeChildrenAction.class, 
                                "LBL_ShowActiveNodeChildrenAction_action_name");
    }
