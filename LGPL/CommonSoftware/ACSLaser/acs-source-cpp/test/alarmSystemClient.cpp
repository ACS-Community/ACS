...
*
*
* "@(#) $Id: alarmSystemClient.cpp,v 1.1.1.1 2010/06/19 15:03:16 acaproni Exp $"
*
*/
...
ACE_RCSID(acsexmpl, alarmSystemClient, "$Id: alarmSystemClient.cpp,v 1.1.1.1 2010/06/19 15:03:16 acaproni Exp $")
