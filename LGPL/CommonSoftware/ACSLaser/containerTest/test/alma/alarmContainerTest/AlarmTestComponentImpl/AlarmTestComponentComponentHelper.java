...
import alma.alarmContainerTest.AlarmTestComponentPOATie;
 ...
 * <p>
 * Name="ALARMTESTCOMPONENT_1" Code="alma.alarmContainerTest.AlarmTestComponentImpl.AlarmTestComponentComponentHelper" Type="IDL:alma/alarmContainerTest/AlarmTestComponent:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class AlarmTestComponentComponentHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public AlarmTestComponentComponentHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new AlarmTestComponentImpl();
	}
	...
	*/
	...
	{
		return AlarmTestComponentPOATie.class;
	}
	...
	*/
	...
	{
		return AlarmTestComponentOperations.class;
	}
