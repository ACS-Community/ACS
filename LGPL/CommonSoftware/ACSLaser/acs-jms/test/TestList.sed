...
s/\(SupplierProxyName='alma.acsjms.test.PubSubTest-\)[0-9]*'/\1xxx'/g
s/\(ConsumerProxyName='alma.acsjms.test.PubSubTest-\)[0-9]*'/\1xxx'/g
s/\(returning from [^ ]* after\) [0-9]*/\1 xxx/g
