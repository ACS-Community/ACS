 ...
 * Schema.
 * $Id: CategoryDescriptor.java,v 1.2 2005/06/14 15:21:12 mslenc Exp $
 */
...
public class CategoryDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl
{
	...
	public CategoryDescriptor()
	{
		...
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(
				...
				"_categoryDefinition", "category-definition",
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler() {
					...
					throws IllegalStateException, IllegalArgumentException
			{
				try {
					Category target = (Category) object;
					target
							.setCategoryDefinition((com.cosylab.acs.laser.dao.xml.CategoryDefinition) value);
		...
		// -- validation code for: _categoryDefinition
	...
	{
		return com.cosylab.acs.laser.dao.xml.Category.class;
