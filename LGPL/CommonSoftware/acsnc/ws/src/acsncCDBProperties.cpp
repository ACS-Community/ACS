...
*
* "@(#) $Id: acsncCDBProperties.cpp,v 1.10 2008/02/06 14:29:25 msekoran Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
...
static char *rcsId="@(#) $Id: acsncCDBProperties.cpp,v 1.10 2008/02/06 14:29:25 msekoran Exp $"; 
...
namespace nc {
	...
	*/
    ...
    //------------------------------------------------------
	char*
	CDBProperties::getNotificationFactoryNameForChannel(const char* channelName, const char* domainName)
	{
	//CDB
	CDB::DAL_var cdbRef = getCDB();
	...
	if(cdbRef.in()==0)
	    ...
	    ACS_STATIC_SHORT_LOG((LM_DEBUG,
				  "CDBProperties::getNotificationFactoryNameForChannel",
				  "CDB ref null."));
	    return 0;
	    }
