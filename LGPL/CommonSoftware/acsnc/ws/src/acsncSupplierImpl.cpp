...
Supplier::createSupplier()
{
    ...
    try
    {
        ...
        ACS_SHORT_LOG((LM_INFO,"<1>proxyConsumer_m->connect_structured_push_supplier proxyID %d",proxyConsumerID));
        proxyConsumer_m->connect_structured_push_supplier(reference_m.in());
        ACS_SHORT_LOG((LM_INFO,"<2>proxyConsumer_m->connect_structured_push_supplier proxyID %d",proxyConsumerID));
    }
    catch(CORBAProblemEx)
    {
        //exception thrown by us...OK to rethrow
