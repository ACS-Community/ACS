/*
 * "@(#) $Id: acstestcompImpl.cpp,v 1.1 2006/09/14 14:54:34 gchiozzi Exp $"
 *
 * $Log: acstestcompImpl.cpp,v $
...
class MultipleReplyThread :public ACS::Thread
{
  public:
	...
	iterationsDone_m(0)
	{
	    ACS_LOG(LM_SOURCE_INFO,"MultipleReplyThread::MultipleReplyThread",
    ...
    virtual void runLoop()
	{
		...
		if(iterationsDone_m < threadData_m->iterations)
		    {
		    iterationsDone_m++;
		    ACS_LOG(LM_SOURCE_INFO,"MultipleReplyThread::runLoop",
...
{
    ACS_LOG(LM_SOURCE_INFO,"TimingExplorerImpl::waitToReply",
...
{
    printf("a\n");
    ACS_LOG(LM_SOURCE_INFO,"TimingExplorerImpl::multipleReplies",
