 ...
 */
public BACIOperation(ANKARemoteAccess ra, OperationDescription desc, SimpleIntrospectable introspectable, String[] parameterNames, Class[] parameterTypes, boolean[] mask, boolean invocation, boolean special) {
	super(desc.name, introspectable, ra.getIntrospector().extractBasicTypeFromTC(desc.result), parameterNames, parameterTypes, mask, invocation, special);
