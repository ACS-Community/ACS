...
public class AlarmTableView {
	 ...
	 * @param act Active
	 */
	public AlarmTableView(String id, String pri, String timestamp, String desc, String cause,String act) {
	...
	public boolean equals(Object obj) {
		if (obj==null || !(obj instanceof AlarmTableView)) {
			return false;
		} else {
			AlarmTableView alarm = (AlarmTableView)obj;
