 ...
 * 
 * @author dfugate
 * @version $Id: AnyAide.java,v 1.1 2008/05/06 15:51:20 jschwarz Exp $
 */
class AnyAide {
	...
	private final ClassLoader acsCL;
	...
	public AnyAide(ContainerServicesBase cs) {
		...
		acsCL = new AcsSystemClassLoader(ClassLoader.getSystemClassLoader());
	...
	public Object complexAnyToObject(Any any) 
	{
		...
		try {
			...
			if (kind.equals(org.omg.CORBA.TCKind.tk_sequence)) {
				...
				localHelper = Class.forName(qualHelperClassName, true, acsCL);
			}
