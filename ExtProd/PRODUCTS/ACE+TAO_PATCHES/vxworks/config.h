/* -*- C++ -*- */
// config-vxworks5.x.h,v 4.110 2006/06/20 20:27:41 shuston Exp
...
#define ACE_HAS_EXPLICIT_STATIC_TEMPLATE_MEMBER_INSTANTIATION 1
...
#define ACE_LACKS_CLEARERR 1
#define ACE_HAS_NAMESPACE 1
