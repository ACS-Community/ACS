...
BuildRequires:  acsJava acsAnt acsTao
...
TOOLS_INSTALL_DIR="$RPM_BUILD_ROOT/alma/%{group}-%{version}/JacORB"
...
rm -rf $RPM_BUILD_ROOT/alma/%{group}-%{version}/JacORB/

%files 
%defattr(-,-,-)
/alma/%{group}-%{version}/JacORB/
