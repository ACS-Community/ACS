...
TOOLS_INSTALL_DIR="$RPM_BUILD_ROOT/alma/%{group}-%{version}/Tomcat"
...
rm -rf $RPM_BUILD_ROOT/alma/%{group}-%{version}/Tomcat

%files 
%defattr(-,-,-)
/alma/%{group}-%{version}/Tomcat
