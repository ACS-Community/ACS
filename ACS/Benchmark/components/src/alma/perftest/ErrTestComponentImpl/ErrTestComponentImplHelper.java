 ...
 */
public class ErrTestComponentImplHelper extends ComponentHelper
{
	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public ErrTestComponentImplHelper(Logger containerLogger)
	{
	...
	{
		return new ErrTestComponentImpl();
	}
	...
	{
		return alma.perftest.ErrTestComponentPOATie.class;
	}
	...
	{
		return alma.perftest.ErrTestComponentOperations.class;
	}
