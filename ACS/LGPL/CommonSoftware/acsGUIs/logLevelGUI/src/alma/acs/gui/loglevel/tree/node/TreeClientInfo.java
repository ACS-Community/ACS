...
/**
 * A container class for the ClientInfo adding some useful method 
 * for tree management
 * 
 * @author acaproni
 *
 */
public class TreeClientInfo implements TreeContentInfo {
	
	// The ClientInfo
	private ClientInfo client;
	
	public TreeClientInfo(ClientInfo cli) {
		if (cli==null) {
