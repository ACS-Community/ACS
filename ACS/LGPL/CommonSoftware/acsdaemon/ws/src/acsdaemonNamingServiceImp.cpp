...
#include "acsNamingServiceImpHandlerImpl.h"

acsDaemonImpl<ACSNamingServiceImpHandlerImpl>* g_daemon = 0; //Reference used by signal handler
...
{
    acsDaemonImpl<ACSNamingServiceImpHandlerImpl> daemon(argc,argv);
