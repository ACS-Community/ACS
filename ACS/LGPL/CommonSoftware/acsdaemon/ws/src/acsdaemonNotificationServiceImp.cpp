...
acsDaemonImpl<ACSNotificationServiceImpHandlerImpl>* g_daemon = 0; //Reference used by signal handler
...
{
    acsDaemonImpl<ACSNotificationServiceImpHandlerImpl> daemon(argc,argv);
