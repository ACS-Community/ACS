...
/**
 * <p>A hash map that uses primitive ints for the key and values instead of objects.</p>
...
public class IntHashMap {
    ...
    private static class Entry {
         ...
         * @param next A reference to the next entry in the table
         */
        public void initialize(int hash, int key, int value, Entry next) {
            this.hash = hash;
            this.key = key;
            this.value = value;
            this.next = next;
     ...
     *          <code>-1</code> if the key is not mapped to any value in
     *          this hashtable.
     * @see     #put(int, Object)
     */
     ...
     *         or <code>-1</code> if it did not have one.
     ...
     *          or <code>-1</code> if the key did not have a mapping.
     */
     ...
     * @param array (new if given not large enough) of values.
     */
