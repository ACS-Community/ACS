...
import alma.COUNTER.CounterConsumerPOATie;
import alma.COUNTER.CounterConsumerImpl.CounterConsumerImpl;
 ...
 * <p>
 * Name="COUNTERCONSUMER_1" Code="alma.COUNTER.CounterConsumerImpl.CounterConsumerHelper" Type="IDL:alma/COUNTER/CounterConsumer:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class CounterConsumerHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public CounterConsumerHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new CounterConsumerImpl();
	}
	...
	*/
	...
	{
		return CounterConsumerPOATie.class;
	}
	...
	*/
	...
	{
		return CounterConsumerOperations.class;
	}
