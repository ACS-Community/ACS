#ifndef _CONSTR_ERROR_HELLO_WORLD_H
#define _CONSTR_ERROR_HELLO_WORLD_H
/*******************************************************************************
...
*
* "@(#) $Id: acsexmplConstrErrorHelloWorld.h,v 1.1 2010/10/22 15:06:01 rbourtem Exp $"
*
* who       when      what
* --------  --------  ----------------------------------------------
...
/** @file acsexmplConstrErrorHelloWorldImpl.h
 */
...
/** @defgroup ACSEXMPLHWDOC Construction Error Hello World
 *  @{
 * @htmlonly
<hr size="2" width="100%">
<div align="left">
 ...
 * which got an error during its construction.
 *
 ...
 * @version "@(#) $Id: acsexmplConstrErrorHelloWorld.h,v 1.1 2010/10/22 15:06:01 rbourtem Exp $"
 */
class ConstrErrorHelloWorld: public virtual acscomponent::ACSComponentImpl,     //Component superclass
...
#endif /*!_CONSTR_ERROR_HELLO_WORLD_H*/
