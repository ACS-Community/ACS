...
s/\(\/.*\)\/acsdata\/tmp\/acs_local_log_\([a-z,A-Z,0-9,_,-]*\)_[0-9]*/...\/acsdata\/tmp\/acs_local_log_\2_xxxx/g
...
s/Manager hostname obtained via environment: '[0-9]\{1,3\}.[0-9]\{1,3\}.[0-9]\{1,3\}.[0-9]\{1,3\}'/Manager hostname obtained via environment: 'xxx'/g