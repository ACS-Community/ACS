 ...
 * @author anzez
 *
 * T23Sampler is JMeter's Java sampler client class to measure time of:
 *  - [TEST_2_3_1] Monitor callback exactness (Delay is callback timer in ms)
 *  - [TEST_2_3_2] Monitor callback throughput/scalability (Delay is measured in 100ns)
 *  - [TEST_2_3_3] Create monitor throughput
 *
 */
public class T23Sampler extends AbstractJavaSamplerClient
{
	private static final String TEST_PREFIX = "TEST_2_3_";
	...
	public void setupTest(JavaSamplerContext context)
	{
		...
		m_delay = context.getLongParameter("Delay", DELAY);
		...
		if (m_test.charAt(0) == '1') {
			m_client.startMonitor(m_delay);
			// first callback should be ignored
			m_client.getNextMonitorResponse();
		}
	}
