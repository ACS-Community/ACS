 ...
 * @author anzez
 *
 * T21Sampler is JMeter's Java sampler client class to measure time of:
 *  - [TEST_2_1_*] Synchronous operations throughput/scalability
 *
 */
public class T21Sampler extends AbstractJavaSamplerClient
{
	private static final String TEST_PREFIX = "TEST_2_1_";
	...
	public SampleResult runTest(JavaSamplerContext context)
	{
		...
		try
		{
			...
			case '1':
				m_client.getPropertySync(sizeOfSet);
				break;
			case '2':
				m_client.setPropertySync(sizeOfSet);
				break;
			case '3':
				b = m_client.getDeviceCharacteristic(sizeOfSet);
				break;
			case '4':
				b = m_client.getPropertyCharacteristic(sizeOfSet);
				break;
			case '5':
				m_client.methodSync(sizeOfSet);
				break;
			default:
