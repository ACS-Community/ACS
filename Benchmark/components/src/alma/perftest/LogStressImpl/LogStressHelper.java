...
import alma.perftest.LogStressWithDelayPOATie;
import alma.perftest.LogStressImpl.LogStressImpl;
 ...
 * <p>
 * Name="LOGSTRESS1" Code="alma.perftest.LogStressImpl.LogStressHelper" Type="IDL:alma/perftest/LogStress:1.0" Container="cppContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class LogStressHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public LogStressHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return LogStressWithDelayPOATie.class;
	}
	...
	*/
	...
	{
		return LogStressWithDelayOperations.class;
	}
