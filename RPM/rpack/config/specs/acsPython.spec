...
TOOLS_INSTALL_DIR="$RPM_BUILD_ROOT/alma/%{group}-%{version}/Python"
...
rm -rf $RPM_BUILD_ROOT/alma/%{group}-%{version}/Python/

%files 
%defattr(-,-,-)
/alma/%{group}-%{version}/Python/
